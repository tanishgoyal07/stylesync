                  ...
                  children: [
                    Text(
                      ...
                      style: const TextStyle(
                        ...
                        color:
                            Color.fromARGB(255, 158, 119, 107), // Pastel brown
                      ),
                    ),
                    const SizedBox(height: 8),
                    Text(
                      designerData['expertCategory'] ?? 'No category',
                      style: const TextStyle(
                        fontSize: 14,
                    ...
                    const SizedBox(height: 8),
                    Text(
                      designerData['experiencedIn'] ?? 'No expertise listed',
                      style: TextStyle(
                        fontSize: 14,
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                      color: Color.fromARGB(255, 106, 175, 110), // Pastel green
                    ),
                  ),
                ],
              ),
